...
import Presentation.*;
import Presentation.Components.BitmapItem;
...
//
//class Services.DemoPresentation extends Accessor {
//
//	public void loadFile(Presentation.Presentation presentation, String unusedFilename) {
//		presentation.setTitle("Demo Presentation.Presentation");
//		Presentation.Components.Slide.Slide slide;
//		slide = new Presentation.Components.Slide.Slide();
//		slide.setTitle("JabberPoint");
//		slide.append(1, "The Java prestentation tool");
//		slide.append(2, "Copyright (c) 1996-2000: Ian Darwin");
//		slide.append(2, "Copyright (c) 2000-now:");
...
//		slide.append(1, " ");
//		slide.append(1, "This is the end of the presentation.");
//		slide.append(new Presentation.Components.BitmapItem(1, "JabberPoint.jpg"));
//		presentation.append(slide);
//	}
//
//	public void saveFile(Presentation.Presentation presentation, String unusedFilename) {
//		throw new IllegalStateException("Save As->Demo! called");
//	}
//}
